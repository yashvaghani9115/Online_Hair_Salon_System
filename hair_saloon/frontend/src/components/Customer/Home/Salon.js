    ...
    return (
        <div className="row shadow-lg p-3 mt-3 bg-white rounded">
            <div className="col-md-4 ml-0">
                <img className="img-fluid float-start " style={{ height: '230px' }} src={fullPathOFImage} alt="#" />
            </div>
                ...
                <p style={{ fontSize: '22px', paddingLeft: '10px', fontFamily: "Monaco" }}>
                    ...
                    <span >
                        <StarRatings
                            ...
                            starDimension='15px'
                        />
                        <div className="ml-2 display-inline rounded-pill badge badge-warning text-dark" style={{ fontSize: '15px'}}>{salon.number_of_rating}</div>
                    </span>
                    <br/>{salon.opening_time < current_time && salon.closing_time > current_time ? <span className="text-success badge rounded-pill">< FcOk /> Open</span> : <span className="text-danger badge rounded-pill"><AiFillCloseCircle /> closed</span>}
